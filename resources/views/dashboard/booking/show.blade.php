                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group col-12 p-2">
                                ...
                                <input type="number" name="day_count" class="form-control"
                                       value="{{$data->day_count ?? ''}}" readonly
                                >
                            </div>
                            <div class="col-md-6 form-group col-12 p-2">
                                <label>@lang('site.commission')<span class="text-danger">*</span></label>
                                                                        <input type="number" name="comision" class="form-control" value="{{$data->comision ?? ''}}" readonly
                                                                        >

{{--                                <select class="js-example-placeholder-multiple col-sm-12" name="comision" readonly--}}
{{--                                        disabled>--}}
...
{{--                                </select>--}}
                            ...
                            <div class="col-md-6 form-group col-12 p-2">
                                <label class="form-label">@lang('site.aquars')</label><span
                                    class="text-danger">*</span>
                                <select class="js-example-placeholder-multiple col-sm-12" name="aqar_id" readonly
                                        disabled>
                                    <option selected>@lang('site.select')</option>
                            ...
                            <div class="col-md-6 form-group col-12 p-2 ">
                                <label class="form-label">@lang('site.status')</label><span
                                    class="text-danger">*</span>
                                <select class="js-example-placeholder-multiple col-sm-12" name="status" readonly
                                        disabled>
                                    <option selected>@lang('site.select')</option>
                            ...
                            <div class="col-md-6 form-group col-12 p-2 ">
                                ...
                                <textarea class="form-control" id="editor1" cols="15" rows="5" name="note" readonly disabled>
{{$data->note ??''}}
                                        </textarea>
                            </div>
