...
<h3>  @lang('site.details') @lang('site.aquar')</h3>

{{--                                            </div>--}}
{{--                                            <div--}}
{{--                                                    class="main-btn d-flex align-items-center justify-content-center"--}}
{{--                                            >--}}
{{--                                                @lang('site.phone')  :  {{$setting->phone_one ?? ''}}--}}
{{--                                            </div>--}}
                                        </div>
                                    </div>
                                    ...
                                    <div class="investor_7agz_card my-4">
                                        <div class="row">
                                            <div class="col-lg-5 mb-3">
                                                ...
                                                <select name="category_id" class="select2" id="cat" readonly="" disabled>
...
{{--                                                    <span>(  @lang('site.Mandatory')  )</span>--}}
                                                ...
                                                <select name="country_id" class="select2" id="country" readonly="" disabled>
                                                    <option disabled selected> @lang('site.select')</option>
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-center mt-md-5 mt-3">
                                            <div
                                                ...
                                                <button type="submit"  onclick="history.back();">  @lang('site.back')</button>
                                            </div>
                                        </div>
