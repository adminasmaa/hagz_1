                ...
                <div class="row">
                    <div class="tabs-details mt-3">
                        ...
                        >
                            ...
                            <li class="{{request()->get('type')==1?'tab-active':'' }}">
                                <a
                                    href="?type=1"
                            ...
                            <li class="{{request()->get('type')==2?'tab-active':'' }}">
                            ...
                            <li class="{{request()->get('type')==3?'tab-active':'' }}">
                            ...
                            <li  class="{{request()->get('type')==4?'tab-active':'' }}">
                                {{--                                //type=canceled (4)--}}
                                <a
                                    href="?type=4"
                                    class="tab-link d-flex align-items-center justify-content-center"
                            ...
                            <li  class="{{request()->get('type')==5?'tab-active':'' }}">
                                {{--                                //type=all (5)--}}
                                <a
                                    href="?type=5"
                                    class="tab-link d-flex align-items-center justify-content-center"
                                                            ...
                                                            <div>
                                                                ...
                                                                >
                                                                    <li class="liItem-booking-out">
                                                                        <a href="{{route('invest.addbooking',$book->aqar_id)}}"
                                                                           class="liItem-link">
                                                                    ...
                                                                    <li class="liItem-booking-edit">
                                                                        <a href="{{route('invest.editads',$book->aqar_id)}}"
                                                                           class="liItem-link">
                                                                    ...
                                                                    <li class="liItem-booking-see">
                                                                        <a href="{{route('detailAqar',$book->aqar_id)}}"
                                                                           class="liItem-link">
                                                                    ...
                                                                    <li class="liItem-booking-stop">
                                                                        <a href="{{route('invest.updatestatus',$book->aqar_id)}}"
                                                                           class="liItem-link">
